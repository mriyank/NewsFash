...
function Post({ name, timestamp, newsHeadline, newsDesc, fakeVoteCount, realVoteCount, aiProbab, judgement }) {
    return (
        <View style={styles.post}>
            ...
            <View style={styles.dashboard}>
                <View style={styles.aiAnalysis}>
                    <AppText style={styles.dashTitle}>Artificial Intelligence Analysis</AppText>
                    <View style={styles.label}>
                        <AppText style={styles.barLabel}>Chances of Realness - {aiProbab * 100}%</AppText>
                    </View>
                    <Progressbar
                        progress={Number(aiProbab)}
                    />
                ...
                <View style={styles.publicOpinion}>
                    ...
                    <View style={styles.voteCount}>
                        <AppText style={{ ...styles.fakePollCount, fontSize: 14, fontWeight: "700" }}>Fake</AppText>
                        <AppText style={{ ...styles.realPollCount, fontSize: 14, fontWeight: "700" }}>Real</AppText>
                    </View>
                    <Progressbar
                        progress={(Number(realVoteCount) / (Number(fakeVoteCount) + Number(realVoteCount)))}
                    />
                    <View style={styles.voteCount}>
                    ...
                    <View style={styles.voteCount}>
                        <Button color="#ffffff" icon="arrow-down-bold-outline">Vote as Fake</Button>
                        <Button color="#ffffff" icon="arrow-up-bold-outline">Vote as Real</Button>
                    </View>
                </View>
                <View style={styles.relateArti}>
                    <Button color="#ffffff" icon="newspaper">See related articles</Button>
                </View>
            </View>
